...
class Geometry(Component):
    ...
    def execute(self):
        self.cl = airfoil_aerodynamics(self.x_foil, self.y_foil, self.u_inf, self.alpha)
...
def airfoil_aerodynamics(x, y, u_inf, alpha):
    """
    Computes everything related to airfoil aerodynamics
